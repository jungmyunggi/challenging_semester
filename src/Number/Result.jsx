...
export default function N_1() {
  ...
  const result3 = {
    ...
    STORAGE: data3[" Storage"]
      ? data3[" Storage"][Object.keys(data3[" Storage"])[0]]
      : null,
  };
  ...
  const xLabels = ["0개월", "1개월", "3개월", "6개월", "1년", "3년", "5년"];
    ...
    >
      ...
      <div className="box" style={{ display: "flex", flexDirection: "row" }}>
        ...
        >
          ...
          <b>가격(hour): US${result1["COST"]}(대략)</b>
        </div>
      ...
      <div style={{ width: "1300px", display: "flex" }}>
        ...
        <LineChart
          ...
          height={500}
          series={[
            { data: A, label: "Cloud A", color: "blue" },
            { data: B, label: "Cloud B", color: "red" },
            { data: C, label: "on-premise", color: "green" },
          ]}
      ...
      <Button
        variant="contained"
        onClick={go_Main}
        style={{ width: "75px", height: "30px", fontSize: "10px" }}
      >
        다시하기
      </Button>
    </div>
